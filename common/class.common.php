...
class PermissionUtil{
    ...
    public static $APPLICATION_TEMPLATE_C = 'APPLICATION_TEMPLATE__C';
    public static $APPLICATION_TEMPLATE_R = 'APPLICATION_TEMPLATE__R';
    public static $APPLICATION_TEMPLATE_U = 'APPLICATION_TEMPLATE__U';
    public static $APPLICATION_TEMPLATE_D = 'APPLICATION_TEMPLATE__D';
}
